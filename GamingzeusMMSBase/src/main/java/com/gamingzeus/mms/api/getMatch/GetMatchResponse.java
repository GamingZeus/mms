...
public class GetMatchResponse extends ServiceResponse {
	...
	public GetMatchResponse(Long challengeId,
			String c1ReportedScore, String c2ReportedScore,
			String c1ReportedWinner, String c2ReportedWinner,
			Date c1ReportedTime, Date c2ReportedTime, Date created) {
		super();
	...
	public String toString() {
		return "GetMatchResponse [challengeId=" + challengeId
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GetMatchResponse other = (GetMatchResponse) obj;
