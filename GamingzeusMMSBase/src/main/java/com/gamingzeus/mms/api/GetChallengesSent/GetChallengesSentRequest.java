...
public class GetChallengesSentRequest extends ServiceRequest {
	...
	public GetChallengesSentRequest(String userId, int page, int size) {
		super();
		this.userId = userId;
		this.page = page;
		this.size = size;
	...
	public GetChallengesSentRequest() {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GetChallengesSentRequest other = (GetChallengesSentRequest) obj;
		if (page != other.page)
			return false;
		if (size != other.size)
			return false;
